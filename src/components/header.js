...
export default function Header({darkMode, setDarkMode}) {
    ...
    return(
        <div className={darkMode === true ? "dark--header" : "header"}>
            <Link to="/feather-weather"><img src={logo} className="logo--image" alt="logo"></img></Link>
            ...
            <div className="header--buttons">
                ...
                <button className={darkMode === true ? "lightmode portal" : "darkmode portal"} onClick={handleDarkMode}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="black" className="bi bi-flower3" viewBox="0 0 16 16">
